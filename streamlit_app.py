# -*- coding: utf-8 -*-
# Modificado desde Colab e integrado con Railway
...
colores_hex = ["#98cfe0", "#2ca6c5", "#032f45", "#f8b909", "#f38e1a"]
custom_cmap = ListedColormap(colores_hex)
categorias = sorted(gdf['tipo_crimen'].unique())
color_dict = {cat: to_hex(custom_cmap(i / max(1, len(categorias) - 1))) for i, cat in enumerate(categorias)}
